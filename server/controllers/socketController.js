...
// finds a user currently in the room -- used to make sure we dont allow a user to join the room if someone already has that username in that room
const getUser = id => usersInRoom.find(user => user.id === id);

// used to retrieve all users in a room
